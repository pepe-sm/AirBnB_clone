...
class TestBaseModel(unittest.TestCase):
    """ This Tests for BaseModel class """
    def test_type_attributes(self):
        """ This Check attribute types """
        base0 = BaseModel()
    ...
    def test_created(self):
        """ This will Check instances after update """
        base1 = BaseModel()
    ...
    def test_instances(self):
        """ This Checks if object isInstance of BaseModel,
    ...
    def test_attributes_created(self):
        """ This will Check if attributes are properly setted """
        base5 = BaseModel()
